      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav>
          <ul className="flex space-x-8">
            ...
            <li>
              <Link to="/cards" className="text-sm text-gray-700 hover:text-black transition-colors">
                Карты
              </Link>
            </li>
            <li>
              <Link to="/instructions" className="text-sm text-gray-700 hover:text-black transition-colors">
                Инструкция
              </Link>
            </li>
          </ul>
